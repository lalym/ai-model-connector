        ...
        <div className="flex-1 flex items-center justify-center">
          <Card className="max-w-sm w-full mx-4">
            ...
            <CardContent className="text-center space-y-4">
              ...
              <div className="text-xs text-left bg-muted rounded-lg p-3 space-y-1 text-muted-foreground">
                <p className="font-medium text-foreground">Перед подключением убедитесь:</p>
                <p>1. В Google Cloud Console включён <strong>People API</strong></p>
                <p>2. В OAuth credentials добавлен Redirect URI:</p>
                <p className="font-mono break-all bg-background rounded px-2 py-1 text-[10px]">
                  {window.location.origin}/api/contacts/oauth/callback
                </p>
              </div>
              <Button className="w-full" onClick={() => { window.location.href = "/api/contacts/oauth/start"; }}>
